...
pagemap_ = gdb.parse_and_eval('\'tcmalloc::Static::pageheap2_\'')
        ...
        for x in range(knumclasses):
            ...
            if objects:
                ...
                for object in objects:
                    print('object: %s' % hex(int(object.addr)))
